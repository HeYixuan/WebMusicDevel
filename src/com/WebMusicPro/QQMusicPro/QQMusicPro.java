package com.WebMusicPro.QQMusicPro;
 ...
 */
public class QQMusicPro implements WebMusicPro {
	private final static String save = "e:\\WebMusic\\QQMusic\\";

	@Override
	public void getInfo(String search_name) {
		new Tools().printList(new QQMusicProUtils().getInfoList(search_name));
	}

	@Override
	public void getMusicList(String link) {
		new Tools().printList(new QQMusicProUtils().getMusicInfoList(link));
	}

	@Override
	public void getInfo(String search_name, int maxpage) {
		new Tools().printList(new QQMusicProUtils().getInfoList(search_name, maxpage));
	}

	@Override
	public String getInfoToString(String search_name) {
		return new Tools().printListString(new QQMusicProUtils().getInfoList(search_name));
	}

	@Override
	public String getInfoToString(String search_name, int maxpage) {
		return new Tools().printListString(new QQMusicProUtils().getInfoList(search_name, maxpage));
	}

	@Override
	public String getMusicListToString(String link) {
		return new Tools().printListString(new QQMusicProUtils().getMusicInfoList(link));
	}

	@Override
	public String[] getInfoToStringArray(String search_name) {
		return new Tools().printListStringArray(new QQMusicProUtils().getInfoList(search_name));
	}

	@Override
	public String[] getInfoToStringArray(String search_name, int maxpage) {
		return new Tools().printListStringArray(new QQMusicProUtils().getInfoList(search_name, maxpage));
	}

	@Override
	public String[] getMusicListToStringArray(String link) {
		return new Tools().printListStringArray(new QQMusicProUtils().getMusicInfoList(link));
	}

	@Override
	public WebMusicProInfo[] getInfoToWebMusicProInfo(String search_name) {
		return new Tools().printListInfo(new QQMusicProUtils().getInfoList(search_name));
	}

	@Override
	public WebMusicProInfo[] getInfoToWebMusicProInfo(String search_name, int maxpage) {
		return new Tools().printListInfo(new QQMusicProUtils().getInfoList(search_name, maxpage));
	}

	@Override
	public WebMusicProInfo[] getMusicListToWebMusicProInfo(String link) {
		return new Tools().printListInfo(new QQMusicProUtils().getMusicInfoList(link));
	}
	...
	public void getInfo(String search_name, int startPage, int endPage) {
		new Tools().printList(new QQMusicProUtils().getInfoList(search_name, startPage, endPage));
	}

	@Override
	public String getInfoToString(String search_name, int startPage, int endPage) {
		return new Tools().printListString(new QQMusicProUtils().getInfoList(search_name, startPage, endPage));
	}

	@Override
	public String[] getInfoToStringArray(String search_name, int startPage, int endPage) {
		return new Tools().printListStringArray(new QQMusicProUtils().getInfoList(search_name, startPage, endPage));
	}

	@Override
	public WebMusicProInfo[] getInfoToWebMusicProInfo(String search_name, int startPage, int endPage) {
		return new Tools().printListInfo(new QQMusicProUtils().getInfoList(search_name, startPage, endPage));
	}
