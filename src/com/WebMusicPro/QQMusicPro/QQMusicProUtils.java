...
* */
public class QQMusicProUtils extends Tools{
	...
	public void getFormat(String song_id, WebMusicProInfo w) {
		...
		String vkey = getByJson(getPagesource(LinkList.QQMusicProLink + song_id + LinkList.QQMusicProLinkFileName
				+ MusicFormat.QQm4aHead + song_id + MusicFormat.m4aEnd), "vkey");
	...
	public List<WebMusicProInfo> getMusicInfoList(String link)
	{
		...
		String page = getMusicListPage(link);
